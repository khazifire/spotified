...
export const getTopTrackMedium = async (refresh_token) => {
  const {access_token} = await getAccessToken(refresh_token);
...
export const getTopArtistsMedium = async (refresh_token) => {
  const {access_token} = await getAccessToken(refresh_token);
...
export const getTopArtistsLong = async (refresh_token) => {
  const {access_token} = await getAccessToken(refresh_token);
